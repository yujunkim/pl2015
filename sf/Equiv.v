...
Proof.
  intros. unfold cequiv. intros. split. intros.
  inversion H0. unfold bequiv in H. subst. rewrite H in H6. inversion H6. subst. apply H7.
  intros. unfold bequiv in H. apply E_IfFalse. apply H. apply H0. (** [] *)
Qed.
...
Proof.
  intros. unfold cequiv. intros. split; intros.
  inversion H. subst. apply E_IfFalse. simpl. rewrite H5. reflexivity. apply H6. subst. apply E_IfTrue. simpl. rewrite H5. reflexivity. apply H6.
  inversion H.  subst. apply E_IfFalse. simpl in H5. apply negb_true_iff in H5. apply H5. apply H6.
...
Proof.
  intros. split; intros.
  inversion H. inversion H2. subst. eapply E_Seq. apply H8. eapply E_Seq. apply H11. apply H5.
  inversion H. inversion H5. subst. eapply E_Seq. eapply E_Seq. apply H2. apply H8. apply H11.
Qed.
(** [] *)
...
Theorem assign_aequiv : forall X e,
  ...
  cequiv SKIP (X ::= e).
Proof.
  intros. split; intros. unfold aequiv in H. replace st' with (update st X (aeval st e)). constructor. reflexivity. apply functional_extensionality. intros. rewrite <- H. simpl. rewrite update_same. inversion H0. reflexivity. reflexivity. inversion H0. subst. replace (update st X (aeval st e)) with st. apply E_Skip. apply functional_extensionality. intros. rewrite <- H. simpl. rewrite update_same. reflexivity. reflexivity. (** [] *)
Qed.
...
Proof.
  ...
  inversion H1. subst.
  apply E_Seq with (st':= st'0). apply H. apply H4. apply H0. apply H7.
...
Proof.
  ...
  inversion H2. subst. apply E_IfTrue. rewrite <- H. apply H8. apply H0. apply H9. subst. apply E_IfFalse. rewrite <- H. apply H8. apply H1. apply H9.
  inversion H2. subst. apply E_IfTrue. rewrite H. apply H8. apply H0. apply H9. subst. apply E_IfFalse. rewrite H. apply H8. apply H1. apply H9.
Qed.
(** [] *)
