...
Proof.
  ...
  intros. inversion H.
  apply multi_refl.
  intros. inversion H. subst. apply multi_trans with (P (C n1) t2).
    apply multistep_congr_1. apply IHt1. apply H2.
    apply multi_trans with (P (C n1) (C n2)).
      apply multistep_congr_2. apply v_const. apply IHt2. apply H4. apply multi_R. apply ST_PlusConstConst.
Qed.
