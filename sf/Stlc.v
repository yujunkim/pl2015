...
Inductive substi (s:tm) (x:id) : tm -> tm -> Prop :=
  ...
  | s_abs1 : forall (T:ty) (t1:tm),
      substi s x (tabs x T t1) (tabs x T t1)
  | s_abs2 : forall (y:id) (T:ty) (t1 t2:tm),
      x <> y ->
      substi s x t1 t2 ->
...
Proof.
  ...
  destruct (eq_id_dec x0 i); simpl; subst; eauto.
  intros. inversion H. simpl. eauto.
  ...
  intros. simpl.
  destruct (eq_id_dec x0 i); simpl; subst; eauto.
  inversion H. reflexivity. subst. exfalso. apply H1. reflexivity.
  inversion H. subst. exfalso. eauto. reflexivity.
  intros. simpl. inversion H. subst. apply IHt1 in H2. apply IHt2 in H4. rewrite H2. rewrite H4. reflexivity.
  intros. simpl.
  destruct (eq_id_dec x0 i); simpl; subst; eauto.
  inversion H. reflexivity. subst. exfalso. apply H4. reflexivity.
  inversion H. subst. exfalso. eauto. subst. simpl. apply IHt in H5. rewrite H5. reflexivity.
  intros. simpl. inversion H. eauto.
  intros. simpl. inversion H. eauto.
  intros. simpl. inversion H. apply IHt1 in H3. apply IHt2 in H5. apply IHt3 in H6. rewrite H3. rewrite H5. rewrite H6.  eauto.
Qed.
(** [] *)
...
Proof.
  apply T_Abs.
  apply T_Abs.
  apply T_App with (TBool). apply T_Var. apply extend_eq. apply T_App with (TBool). apply T_Var. apply extend_eq.
...
Proof with auto.
  eapply ex_intro.
  apply T_Abs. apply T_Abs. apply T_Abs. eapply T_App. apply T_Var... unfold extend. simpl. reflexivity.
  eapply T_App. apply T_Var... unfold extend. simpl. reflexivity. apply T_Var. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  inversion H2.
  subst.
  induction T11. inversion H4. inversion H4. apply IHT11_1. eapply ex_intro. apply T_Abs.
  eapply T_App. apply T_Var. rewrite H1. eauto. eauto. eauto. rewrite H1.  eauto.
Qed.
(** [] *)
